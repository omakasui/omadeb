--
-- Dynamic Omadeb Theme Menu for Elephant/Walker
--
Name = "omadebthemes"
NamePretty = "Omadeb Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/omadeb/themes"
  local omadeb_path = os.getenv("OMADEB_PATH") or ""
  local default_theme_dir = omadeb_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "omadeb-theme-set " .. theme_name,
            },
          })
        end
      end
